...
public struct InGameFacilityData : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static InGameFacilityData GetRootAsInGameFacilityData(ByteBuffer _bb) { return GetRootAsInGameFacilityData(_bb, new InGameFacilityData()); }
  public static InGameFacilityData GetRootAsInGameFacilityData(ByteBuffer _bb, InGameFacilityData obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public InGameFacilityData __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<BanpoFri.Data.InGameFacilityData> CreateInGameFacilityData(FlatBufferBuilder builder,
      int groundidx = 0,
      int facilitygrade = 0,
    ...
    InGameFacilityData.AddLandbenefittime(builder, landbenefittime);
    InGameFacilityData.AddLandstatuseventidx(builder, landstatuseventidx);
    InGameFacilityData.AddFacilitygrade(builder, facilitygrade);
    InGameFacilityData.AddGroundidx(builder, groundidx);
    InGameFacilityData.AddIseventground(builder, iseventground);
    return InGameFacilityData.EndInGameFacilityData(builder);
  }

  public static void StartInGameFacilityData(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<BanpoFri.Data.InGameFacilityData> EndInGameFacilityData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<BanpoFri.Data.InGameFacilityData>(o);
  }
};
