...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollSnap
    {
        ...
        void Start()
        {
            ...
            {
                var hscroll = _scroll_rect.horizontalScrollbar.gameObject.GetComponent<ScrollSnapScrollbarHelper>();
                if(hscroll == null)
                    hscroll = _scroll_rect.horizontalScrollbar.gameObject.AddComponent<ScrollSnapScrollbarHelper>();
                hscroll.ss = this;
            }
            if (_scroll_rect.verticalScrollbar != null && _scroll_rect.vertical)
            {
                var vscroll = _scroll_rect.horizontalScrollbar.gameObject.GetComponent<ScrollSnapScrollbarHelper>();
                if(vscroll == null)
                    vscroll = _scroll_rect.horizontalScrollbar.gameObject.AddComponent<ScrollSnapScrollbarHelper>();
                vscroll.ss = this;
            }
        }
